  ...
  describe("placeOrderFromCart", () => {
    ...
    it("successfully places order and marks source cart as converted while preserving guest_token_hash", async () => {
      ...
      const createdOrderItemRow = {
        ...
        size_option: "42",
        price_in_cents: 8500,
        authoritative_price_in_cents: 8500,
        quantity: 1,
        total_in_cents: 8500,
                ...
                rows: [
                  {
                    ...
                    size_option: "9",
                    price_in_cents: 9900,
                    authoritative_price_in_cents: 9900,
                    variant_active: true,
                    quantity_on_hand: 5,
                    backorderable: false,
                    product_id: "prod-1",
                ...
                rows: [
                  {
                    ...
                    authoritative_price_in_cents: 14500, // $145.00 PostgreSQL authoritative price
                    variant_active: true,
                    quantity_on_hand: 5,
                    backorderable: false,
                    product_id: "prod-1",
                ...
                rows: [
                  {
                    ...
                    order_id: "ord-1",
                    price_in_cents: 14500,
                    authoritative_price_in_cents: 14500,
                    quantity: 2,
                    total_in_cents: 29000,
                  },
                ],
                ...
                rows: [
                  {
                    ...
                    price_in_cents: 8000,
                    authoritative_price_in_cents: 8000,
          ...
          rows: [
            {
              ...
              size_option: "41",
              price_in_cents: 5000,
              authoritative_price_in_cents: 5000,
              quantity: 1,
              total_in_cents: 5000,
              thumbnail_url: null,
              created_at: new Date(),
